...
text = input('Введите текст: ') # Создаём список гласных букв, которые есть в тексте
...
winners = [first_team[i_player] if first_team[i_player] > second_team[i_player] else second_team[i_player] for i_player in range(20)]
# Вывод данных
